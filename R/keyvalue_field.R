...
#' @param key Character vector, options for autocompletion in the key field. Can
#'   be "suggest", "empty", or "none". Default is c("suggest", "empty", "none").
...
#' @param delete_button Logical, whether to include a delete button for the
#'   expression. Default is TRUE.
#' @param key Character vector, options for autocompletion. Can be "suggest",
#'   "empty", or "none". Default is c("suggest", "empty", "none").
