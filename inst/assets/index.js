...
window.Shiny.addCustomMessageHandler("blockr-bind-stack", (msg) => {
  ...
  setTimeout(() => {
    ...
    (0,_lock_js__WEBPACK_IMPORTED_MODULE_3__.renderLocked)(stack);
