...
```{r select-block, fig.cap="Select block interface"}
...
```{r filter-block, fig.cap="Filter block interface"}
...
```{r value-filter-block, fig.cap="Value filter block interface"}
...
```{r arrange-block, fig.cap="Arrange block interface"}
...
```{r slice-block, fig.cap="Slice block interface"}
...
```{r mutate-block, fig.cap="Mutate block interface"}
...
```{r rename-block, fig.cap="Rename block interface"}
...
```{r summarize-block, fig.cap="Summarize block interface"}
...
```{r join-block, fig.cap="Join block interface"}
...
```{r bind-rows-block, fig.cap="Bind rows block interface"}
...
```{r bind-cols-block, fig.cap="Bind columns block interface"}
...
```{r pivot-longer-block, fig.cap="Pivot longer block interface"}
...
```{r pivot-wider-block, fig.cap="Pivot wider block interface"}
