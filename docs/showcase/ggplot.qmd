...
```{r ggplot-scatter, out.width="50%", fig.cap="ggplot block: scatter plot"}
...
```{r ggplot-bar, out.width="50%", fig.cap="ggplot block: bar chart"}
...
```{r ggplot-line, out.width="50%", fig.cap="ggplot block: line chart"}
...
```{r ggplot-boxplot, out.width="50%", fig.cap="ggplot block: box plot"}
...
```{r ggplot-violin, out.width="50%", fig.cap="ggplot block: violin plot"}
...
```{r ggplot-density, out.width="50%", fig.cap="ggplot block: density plot"}
...
```{r ggplot-area, out.width="50%", fig.cap="ggplot block: area chart"}
...
```{r ggplot-histogram, out.width="50%", fig.cap="ggplot block: histogram"}
...
```{r ggplot-pie, out.width="50%", fig.cap="ggplot block: pie chart"}
...
```{r ggplot-donut, out.width="50%", fig.cap="ggplot block: donut chart"}
...
```{r facet-wrap, out.width="50%", fig.cap="Facet block: wrap layout"}
...
```{r facet-grid, out.width="50%", fig.cap="Facet block: grid layout"}
...
```{r theme, out.width="50%", fig.cap="Theme block"}
...
```{r grid, out.width="50%", fig.cap="Grid block"}
