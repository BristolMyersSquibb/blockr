...
Under the hoods, blocks are composed of __fields__. The latter are used to convey interactivity within the block.
As you can see in the below diagram, fields are combined to compute an expression, which eventually leads to a block result after evaluation. For a data block, there is no data input.
